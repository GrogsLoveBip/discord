...
const buttons = require('./functions/components/buttons.cjs');
const components = require('./functions/components/components.cjs');
...
exports.ContainerPlusBuilder = container.ContainerPlusBuilder;
...
exports.isChannelSelectMenuBuilder = selectmenu.isChannelSelectMenuBuilder;
exports.isMentionableSelectMenuBuilder = selectmenu.isMentionableSelectMenuBuilder;
